...
class UpdateReservationDialog extends BookingDialog
{
  ...
  UpdateReservationDialog(Frame owner, String title)
  {
  ...
  UpdateReservationDialog(Frame owner, String title, Reservation r)
  {
    super(owner, title, r) ;
